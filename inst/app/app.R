...
#DATA----
new <- read.csv(system.file("app/data.csv", package = "PP4MH"))
...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            hr(),
            p("Size and color represent the intensity of the selected variable ", style = "font-size: 14px; color: #7f8c8d;"),
            p("Data Source:Mission Antyodaya 2020", style = "font-size: 14px; color: #7f8c8d;")
        ),
        ...
        mainPanel(
            ...
            fluidRow(
                column(
                    width = 12,
                    plotlyOutput("bubbleMap", height = "700px")
                )
            ),
